        ...
        <div class="page-content">
            <div class="portlet box blue tabbable">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-car"></i>Unit Status
                    </div>
                </div>
                            ...
                            <div>
                                    ...
                                    <form class="form-horizontal" action="{{ route('maintenance.status.update', ['status' => $item->id]) }}" method="POST" role="form">
                                        ...
                                        <div class="portlet grey-gallery box">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-edit"></i>Update Unit Status
                                                </div>
                                            </div>
                                            <div class="portlet-body"><br><br>
                                                <div class="row">
                                                    <div class="col-md-12 margin-bottom-10">
                                                        ...
                                                        <div class="col-md-9">
                                                        <input type="text" size="16" name="name" class="form-control" value="{{$item->status}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-actions" style="margin-left:20px;">
                                                    <button type="submit" class="btn btn-sm blue">Update</button>
                                                    <a href="{{route('maintenance.status.index')}}" class="btn btn-sm default">Cancel</a> <br><br>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                    @endisset
                                    {{-- Show table --}}
                                    <table class="table table-striped table-condensed" id="sample_2" style="font-size:12px;">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Name</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="right">
                                                    ...
                                                    @method('delete')
                                                    @csrf
                                                    <a href="{{ route('maintenance.status.edit', ['status' => $item->id]) }}" class="btn green btn-xs"><i class="fa fa-edit"></i></a>
