						...
						<div class="mega-menu-content">
							<div class="row">
								...
								{{-- <ul class="col-md-6 mega-menu-submenu">
									...
									<li><a href="{{ route('vehicle.report.dipstachdepartment') }}"><i class="fa fa-building-o"></i> Dispatchs Distribution per Department</a></li>
									<li><a href="{{ route('vehicle.report.total.dispatch') }}"><i class="fa fa-send"></i> Top Vehicles by number of Dispatches</a></li>
									<li><a href="{{ route('vehicle.report.total.distance') }}"><i class="fa fa-truck"></i> Top Vehicles by Distance Travelled</a></li>
									<li><a href="{{ route('vehicle.report.topdestination')}}"><i class="fa fa-globe"></i> Top Frequent Destinations</a></li>
									<li><a href="{{ route('vehicle.report.trip')}}"><i class="fa fa-tags"></i> Trip Tickets</a></li>
									<li><a href="{{ route('vehicle.report.request.raw') }}"><i class="fa fa-tags"></i> Vehicle Request Raw Data</a></li>
								</ul> --}}
						...
						<div class="mega-menu-content">
							<div class="row">
								<ul class="col-md-6 mega-menu-submenu">
									...
									<li class="dropdown-submenu">
										<a href="javascript:;">
											<i class="fa fa-car"></i> Vehicle Master File </a>
										<ul class="dropdown-menu">
