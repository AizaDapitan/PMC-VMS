    ...
    public function weekly(Request $request, $week = null){  
        ...
        if($request->from!==null && $request->to!==null) {  
            ...
            if($request->unit!==null) {
                ...
                $fresult = FMSIssuanceRequest::where('created_at','>=',$request->from.' 00:00:01')->where('created_at','<=',$request->to.' 23:59:59')->where(function ($query) use ($c,$d){  $query->where('vehicle_id', '=', $c)
