...
<div class="page-container">
	<form method="POST" id="downtimeform" action="{{ action('DowntimeController@update', ['downtime' =>  $id]) }}">
		@csrf
		{{ method_field('PATCH') }}
							...
							<div class="col-md-12 margin-bottom-10">
								...
								<div class="col-md-9">
									<select class="form-control" name="unit" id="unit" required>
										...
										@if($item->id == '')
										<option value="{{$item->id}}" selected="selected"> {{$item->type}} " " {{$item->name}} </option>
										@else
							...
							<div class="col-md-12 margin-bottom-10">
								...
								<div class="col-md-9">
									<select class="form-control" name="assigned_to" id="assigned_to">
										...
										@if($item->name == $result->assignedTo)
					...
					<div class="col-md-6">
							...
							<div class="col-md-12 margin-bottom-10">
								...
								<div class="col-md-9">
									<div class="input-group">
										<input class="form-control" onchange="checkdates('startd')" value="{!! date('Y-m-d', strtotime($result->ds)) . " T" . date('H:i', strtotime($result->ds)) !!}" type="datetime-local" id="startd" name="startd" />
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-12 margin-bottom-10">
								...
								<div class="col-md-9">
									<div class="input-group">
										<input class="form-control" onchange="checkdates('endd')" value="{!! date('Y-m-d', strtotime($result->de)) . " T" . date('H:i',strtotime($result->de)) !!}" type="datetime-local" id="endd" name="endd" />
									</div>
								</div>
							</div>
						</div>
