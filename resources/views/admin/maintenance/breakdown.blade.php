        ...
        <div class="page-content">
            <div class="portlet box blue tabbable">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-car"></i>Breakdown - Repair Type
                    </div>
                </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="portlet_tab_1">
                                <div style="height: 35px;">
                                    <div style="h-100">
                                        <a href="{{route('maintenance.export', ['type' => 'breakdown'])}}" target="_blank" type="button" class="btn btn-success btn-xs">Export to Excel</a>
                                    </div>
                                </div>
                            <div>
                                    {{-- Show update when clicked edit bttn --}}
                                    @isset($item)
                                    <form class="form-horizontal" action="{{ route('maintenance.breakdown.update', ['breakdown' => $item->id]) }}" method="POST" role="form">
                                        @csrf
                                        {{ method_field('PATCH') }}
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        <form action="{{route('maintenance.breakdown.destroy', ['breakdown' => $item->id])}}" method="POST">
                                                            @method('delete')
                                                            @csrf
                                                            <a href="{{ route('maintenance.breakdown.edit', ['breakdown' => $item->id]) }}" class="btn green btn-xs"><i class="fa fa-edit"></i></a>
                            ...
                            {{-- CONTENT TAB #2 --}}
                                <h3>Add New</h3>
                                <form action="{{route('maintenance.breakdown.store')}}" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12 margin-bottom-10">
                                            <label class="control-label col-md-3">Name</label>
